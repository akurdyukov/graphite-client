...
namespace Graphite.Wcf
{
    public class MetricsPipeMessageInspector : IDispatchMessageInspector
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MetricsPipeMessageInspector"/> class.
        /// </summary>
        public MetricsPipeMessageInspector(MetricSetting reportRequestTime = null, MetricSetting reportHitCount = null) 
            : base()
        {
        ...
        /// <summary>
        /// Adds an instance of the <see cref="MetricsPipeInstance"/> class to the current operation context after an inbound message has been received but before the message is dispatched to the intended operation.
        /// </summary>
        ...
        {
            WcfMetricsPipeProvider.Instance.Start();
